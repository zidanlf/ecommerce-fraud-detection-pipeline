...
try:
    while True:
        ...
        data = {
            ...
            "quantity": random.randint(1, 150), # Range lebar biar ada yg > 100 (Fraud)
            "amount": random.randint(50000, 200000000), # Range lebar biar ada yg > 100jt (Fraud)
            "voucher_code": voucher_code,
            "country": random.choice(['ID', 'ID', 'ID', 'US', 'SG']), # Kebanyakan ID, sesekali luar negeri
